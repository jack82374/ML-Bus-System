        ...
        if (maintence_settings.maintenance_mode == False):
            try:
                ...
                try:
                    ...
                    for location in locations.get('entity', []):
                        ...
                        if (location['vehicle']['trip']['schedule_relationship'] == 'ADDED' and
                            (location['vehicle']['trip']['route_id'] == '97732' or location['vehicle']['trip']['route_id'] == '97735')):
                        ...
                        elif location['vehicle']['trip']['route_id'] == '97732' or location['vehicle']['trip']['route_id'] == '97735':
                        ...
                        if (location['vehicle']['trip']['route_id'] == '97732' or location['vehicle']['trip']['route_id'] == '97735'):
                            #print(location)
                ...
                for update in trip_updates.get('entity', []):
                    ...
                    if update['trip_update']['trip']['schedule_relationship'] == 'ADDED' and (update['trip_update']['trip']['route_id'] == '97732' or update['trip_update']['trip']['route_id'] == '97735'):
                        #print(update)
                        ...
                        try:
                            ...
                            continue
                    elif (update['trip_update']['trip']['route_id'] == '97732' or update['trip_update']['trip']['route_id'] == '97735'):
                    ...
                    if (update['trip_update']['trip']['route_id'] == '97732' or update['trip_update']['trip']['route_id'] == '97735'):
